        ...
        create or replace transient table SWIGGY.marts.mart_restaurant_performance
         as
        (select 
...
from SWIGGY.marts.fct_orders f 
left join SWIGGY.marts.dim_restaurants r using (restaurant_id) 
group by 1,2,3,4
        );
