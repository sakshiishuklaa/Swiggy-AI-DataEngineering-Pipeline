  ...
  create or replace   view SWIGGY.staging.stg_reviews
...
res.city as city,
from SWIGGY.RAW.reviews r
left join SWIGGY.staging.stg_restaurants res on r.restaurant_id = res.restaurant_id
